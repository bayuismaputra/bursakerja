...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="menu">
        <div class="container">
            <a class="navbar-brand" href="?menu=halaman_utama">BURSA KERJA TI</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link active" href="daftar.php">Daftar<span class="sr-only">(current)</span></a>
                    <a class="nav-item nav-link" href="login.php">Masuk</a>
                    <a class="nav-item btn tombol" href="#">Perusahaan</a>
                </div>
            </div>
        </div>
    </nav>